...
- Fixed the Xaero's World Map overlay mixin for Xaero's World Map `1.41.1` on
  this Minecraft branch by keeping the branch-verified exact injection anchor
  wrapped in the new guarded mixin structure.
- Updated the 26.2 branch's exact injection anchor to the current
